...
Здесь можно настроить видимость глобального чата, донат-чата, подсказок[^2], сообщений о входах и выходах, и сообщений от игнорируемых вами игроков. Также вы можете выбрать, кто сможет отправлять вам личные сообщения (все игроки/друзья/никто).
...
| Чат           | Условие                                                                                                                                                               |
| ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Локальный     | Написать обычное сообщение в [мире](../creative/world/).                                                                                                              |
...
Почта позволяет отправлять сообщения игрокам офлайн.

| Команда                    | Описание                            |
| -------------------------- | ----------------------------------- |
| `/mail send <ник> <текст>` | Отправить письмо игроку.            |
| `/mail list`               | Открыть список непрочитанных писем. |
| `/mail read <id>`          | Отметить письмо прочитанным.        |
| `/mail delete <id>`        | Удалить письмо.                     |
| `/mail all-read`           | Удалить все прочитанные письма.     |
| `/mail dialog <ник>`       | Открыть переписку с игроком.        |
...
[^1]: <img src="../.gitbook/assets/chat_settings_menu.png" alt="" data-size="original">

[^2]: Подсказки отправляются в чат с определённой периодичностью и содержат полезную информацию, которая может понадобиться новым игрокам.\
    \
    Отключить можно нажатием на крестик рядом с подсказкой, в настройках чата, либо командой `/hints off`.
