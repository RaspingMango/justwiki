...
Для подключения этой интеграции введите команду `/profile` и перейдите в раздел **Интеграции**. Затем, в открытом меню, выберите вариант **Интеграция с Telegram**. В чат отправится ссылка, по которой необходимо перейти и авторизовать свой Telegram-аккаунт.

## <i class="fa-vk">:vk:</i> VK
...
## <i class="fa-envelope">:envelope:</i> Электронная почта
