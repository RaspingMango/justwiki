...
| Команда                               | Описание                                                            |
| ------------------------------------- | ------------------------------------------------------------------- |
| [`/gamemode`](#user-content-fn-5)[^5] | Изменить режим игры.                                                |
| `/give`                               | Выдать любой предмет игроку.                                        |
| [`/teleport`](#user-content-fn-6)[^6] | Телепортироваться в любое место или телепортировать другого игрока. |
...
| [`/gamerule`](#user-content-fn-7)[^7]   | Изменить игровые правила мира.                                                                                                                     |
| `/time`                                 | Изменить текущее время в мире.                                                                                                                     |
| `/weather`                              | Изменить текущую погоду в мире.                                                                                                                    |
| [`/enviroment`](#user-content-fn-8)[^8] | Управление переменными и инвентарями игроков.                                                                                                      |
{% endtab %}
...
| Команда                                     | Описание                                                      |
| ------------------------------------------- | ------------------------------------------------------------- |
| `/item`                                     | Открыть [меню редактора предметов](#user-content-fn-12)[^12]. |
...
| [`/item enchant`](#user-content-fn-13)[^13] | Установить зачарование предмету.                              |
| `/item equip`                               | Поместить предмет в слоты для брони.                          |
| [`/item lore`](#user-content-fn-14)[^14]    | Редактировать описание предмета.                              |
| `/item material`                            | Заменить предмет на другой, сохранив все показатели.          |
| `/item modeldata`                           | Редактировать значение ModelData.                             |
| [`/item rename`](#user-content-fn-15)[^15]  | Переименовать предмет.                                        |
| `/item send`                                | Отправить предмет игроку в инвентарь.                         |
| [`/item trim`](#user-content-fn-16)[^16]    | Применить кузнечный шаблон к элементу брони.                  |
...
* <img src="../../.gitbook/assets/chest.png" alt="" data-size="line"> [**Мои миры**](#user-content-fn-4)[^4] — список ваших миров.
...
[^5]: Можно заменить на: `/gm`

[^6]: Можно заменить на: `/tp`
