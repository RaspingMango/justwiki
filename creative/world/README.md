...
| `//replace`      | Заменяет один тип блоков на другой в выделенной зоне.                                           | <i class="fa-globe">:globe:</i> **Planet**   |
| `//copy`         | Копирует выделенную область в буфер обмена.                                                     | <i class="fa-globe">:globe:</i> **Planet**   |
| `//paste`        | Вставляет скопированную область в текущее местоположение.                                       | <i class="fa-globe">:globe:</i> **Planet**   |
| `//rotate`       | Поворачивает скопированную область на заданный угол.                                            | <i class="fa-globe">:globe:</i> **Planet**   |
| `//flip`         | Отражает выделенный регион по выбранной оси (X, Y, Z).                                          | <i class="fa-globe">:globe:</i> **Planet**   |
| `//clear`        | Очищает буфер обмена (удаляет сохранённую копию).                                               | <i class="fa-globe">:globe:</i> **Planet**   |
| `//cut`          | Вырезает выделенную область, перенеся её в буфер обмена.                                        | <i class="fa-globe">:globe:</i> **Planet**   |
| `//place`        | Вставляет скопированную область в текущее местоположение без применения трансформаций.          | <i class="fa-globe">:globe:</i> **Planet**   |
| `//pyramid`      | Создаёт пирамиду из выбранного блока с заданным размером.                                       | <i class="fa-globe">:globe:</i> **Planet**   |
| `//hollow`       | Делает структуру полой, удаляя внутренние блоки.                                                | <i class="fa-globe">:globe:</i> **Planet**   |
| `//extinguish`   | Удаляет огонь и лаву в выделенной области.                                                      | <i class="fa-globe">:globe:</i> **Planet**   |
