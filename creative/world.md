...
После создания мира ему присваивается свой ID. Это уникальный номер, который никак нельзя изменить. Посмотреть его можно в <img src="../.gitbook/assets/compass.png" alt="" data-size="line"> [**Настройках мира**](#user-content-fn-2)[^2], либо в меню <img src="../.gitbook/assets/grass_block.png" alt="" data-size="line"> **Мои миры**.
...
| Команда                                 | Описание                                                                                                                                                                                |
| --------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`/spawn`](#user-content-fn-8)[^8]      | <p>Выйти из мира на спавн <a data-footnote-ref href="#user-content-fn-9">режима</a>.<br>Владелец мира может указать ник игрока, который впоследствии будет телепортирован на спавн.</p> |
| [`/favorite`](#user-content-fn-10)[^10] | Добавить мир в [**Избранные миры**](world.md#menyu-imeet-sleduyushie-razdely).                                                                                                          |
...
* <img src="../.gitbook/assets/paper.png" alt="" data-size="line"> [**Недавние миры**](#user-content-fn-15)[^15] — список миров, куда вы недавно заходили.
* <img src="../.gitbook/assets/gold_block.png" alt="" data-size="line"> [**Избранные миры**](#user-content-fn-16)[^16] — список миров, избранных пользователем.
...
[^2]: ![](../.gitbook/assets/world\_settings\_menu.png)
...
[^15]: ![](../.gitbook/assets/history\_worlds\_menu.png)

[^16]: ![](../.gitbook/assets/favorite\_worlds\_menu.png)
