...
При запуске мира в [режиме строительства](world.md#sostoyaniya-mira) вам выдаётся специальный предмет, открывающий <img src="../.gitbook/assets/compass.png" alt="" data-size="line"> [**Настройки мира**](#user-content-fn-5)[^5]. Но если вы находитесь в режиме игры, либо компаса по каким-либо причинам у вас нет, то данное меню можно открыть и другим способом — например, командой `/world` или `/plot`.
...
* <img src="../.gitbook/assets/chest.png" alt="" data-size="line"> [**Мои миры**](#user-content-fn-19)[^19] — список ваших миров.
