...
[^47]: **Направление удара** `direction`:
...
[^52]: **Тип отображения частиц** `unit_of_measurement`:
...
[^55]: **Видимость для игрока** `visible_to_self`:
...
[^56]: **Тип сервера скинов** `server_type`:
...
[^61]: **Установить визуальный огонь** `visual_fire`:
