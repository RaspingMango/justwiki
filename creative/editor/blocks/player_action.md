...
<table data-full-width="true"><thead><tr><th>Опция</th><th>Описание</th><th>Аргументы</th></tr></thead><tbody><tr><td><img src="../../../.gitbook/assets/golden_pickaxe.png" alt="" data-size="line"> <strong>Установить режим игры</strong><br><code>player_set_gamemode</code></td><td>Устанавливает режим игры для игрока.</td><td><a href="../arguments/parameter/enum.md"><img src="../../../.gitbook/assets/heart_of_the_sea.png" alt="" data-size="line"></a> <strong>Режим игры</strong> <a data-footnote-ref href="#user-content-fn-28"><strong><code>-></code></strong></a><br><a href="../arguments/parameter/enum.md"><img src="../../../.gitbook/assets/heart_of_the_sea.png" alt="" data-size="line"></a> <strong>Режим полёта</strong> <a data-footnote-ref href="#user-content-fn-29"><strong><code>-></code></strong></a></td></tr><tr><td><img src="../../../.gitbook/assets/feather.png" alt="" data-size="line"> <strong>Установить разрешение полёта игрока</strong><br><code>player_set_allow_flying</code></td><td>Устанавливает разрешение полёта для игрока.</td><td><a href="../arguments/parameter/enum.md"><img src="../../../.gitbook/assets/heart_of_the_sea.png" alt="" data-size="line"></a> <strong>Может летать</strong> <a data-footnote-ref href="#user-content-fn-30"><strong><code>-></code></strong></a></td></tr><tr><td><img src="../../../.gitbook/assets/netherite_sword.png" alt="" data-size="line"> <strong>Установить разрешение атаковать игроков</strong><br><code>player_set_pvp</code></td><td>Устанавливает разрешение игроку атаковать других игроков и наносить им урон.</td><td><a href="../arguments/parameter/enum.md"><img src="../../../.gitbook/assets/heart_of_the_sea.png" alt="" data-size="line"></a> <strong>Может атаковать</strong> <a data-footnote-ref href="#user-content-fn-31"><strong><code>-></code></strong></a></td></tr><tr><td><img src="../../../.gitbook/assets/redstone.png" alt="" data-size="line"> <strong>Установить выпадение предметов</strong><br><code>player_set_death_drops</code></td><td>Устанавливает выпадение предметов из игрока при смерти.</td><td><a href="../arguments/parameter/enum.md"><img src="../../../.gitbook/assets/heart_of_the_sea.png" alt="" data-size="line"></a> <strong>Выпадение предметов</strong> <a data-footnote-ref href="#user-content-fn-32"><strong><code>-></code></strong></a></td></tr><tr><td><img src="../../../.gitbook/assets/ender_chest.png" alt="" data-size="line"> <strong>Установить сохранение инвентаря</strong><br><code>player_set_inventory_kept</code></td><td>Устанавливает игроку сохранение инвентаря при смерти.</td><td><a href="../arguments/parameter/enum.md"><img src="../../../.gitbook/assets/heart_of_the_sea.png" alt="" data-size="line"></a> <strong>Сохранение инвентаря</strong> <a data-footnote-ref href="#user-content-fn-33"><strong><code>-></code></strong></a></td></tr><tr><td><img src="../../../.gitbook/assets/glass.png" alt="" data-size="line"> <strong>Установить режим столкновения</strong><br><code>player_set_collidable</code></td><td>Устанавливает игроку режим столкновения с существами.</td><td><a href="../arguments/parameter/enum.md"><img src="../../../.gitbook/assets/heart_of_the_sea.png" alt="" data-size="line"></a> <strong>Режим столкновения</strong> <a data-footnote-ref href="#user-content-fn-34"><strong><code>-></code></strong></a></td></tr><tr><td><img src="../../../.gitbook/assets/glass_bottle.png" alt="" data-size="line"> <strong>Установить видимость</strong><br><code>player_set_default_visible</code></td><td>Устанавливает игроку видимость.<br><br>» Видимость игрока может быть изменена через действие <a href="player_action.md#mir"><img src="../../../.gitbook/assets/player_head.png" alt="" data-size="line"> <strong>Скрыть сущность игроку</strong></a>.</td><td><a href="../arguments/parameter/enum.md"><img src="../../../.gitbook/assets/heart_of_the_sea.png" alt="" data-size="line"></a> <strong>Видимость</strong> <a data-footnote-ref href="#user-content-fn-35"><strong><code>-></code></strong></a></td></tr><tr><td><img src="../../../.gitbook/assets/name_tag.png" alt="" data-size="line"> <strong>Отображение ника игрока</strong><br><code>player_set_nametag_visible</code></td><td>Отобразит или скроет ник над головой.</td><td><a href="../arguments/parameter/enum.md"><img src="../../../.gitbook/assets/heart_of_the_sea.png" alt="" data-size="line"></a> <strong>Отображение ника</strong> <a data-footnote-ref href="#user-content-fn-36"><strong><code>-></code></strong></a></td></tr><tr><td><img src="../../../.gitbook/assets/totem_of_undying.png" alt="" data-size="line"> <strong>Установить мгновенное возрождение</strong><br><code>player_set_instant_respawn</code></td><td>Устанавливает мгновенное возрождение игроку.</td><td><a href="../arguments/parameter/enum.md"><img src="../../../.gitbook/assets/heart_of_the_sea.png" alt="" data-size="line"></a> <strong>Мгновенное возрождение</strong> <a data-footnote-ref href="#user-content-fn-37"><strong><code>-></code></strong></a></td></tr><tr><td><img src="../../../.gitbook/assets/map.png" alt="" data-size="line"> <strong>Установить местоположение возрождения</strong><br><code>player_set_spawn_point</code></td><td>Устанавливает игроку новое местоположение возрождения.</td><td><a href="../arguments/location.md"><img src="../../../.gitbook/assets/map.png" alt="" data-size="line"></a> <strong>Местоположение возрождения</strong></td></tr><tr><td><img src="../../../.gitbook/assets/lodestone.png" alt="" data-size="line"> <strong>Установить стиль значка на локаторе</strong><br><code>player_set_waypoint_style</code></td><td>Устанавливает игроку стиль значка, отображаемого на локаторе.<br><br>» Для работы действия, игровое правило "Видимость локатора" должно быть включено.<br>» По умолчанию в игре есть два стиля для значка: "minecraft:default" и "minecraft:bowtie".<br>» Оставьте аргумент "Ключ стиля" пустым, чтобы вернуть значение по умолчанию.</td><td><a href="../arguments/text.md"><img src="../../../.gitbook/assets/book.png" alt="" data-size="line"></a> <strong>Ключ стиля</strong></td></tr><tr><td><img src="../../../.gitbook/assets/pink_dye.png" alt="" data-size="line"> <strong>Установить цвет значка на локаторе</strong><br><code>player_set_waypoint_color</code></td><td>Устанавливает игроку цвет значка, отображаемого на локаторе.<br><br>» Для работы действия, игровое правило "Видимость локатора" должно быть включено.</td><td><a href="../arguments/number.md"><img src="../../../.gitbook/assets/slime_ball.png" alt="" data-size="line"></a> <strong>Красный (0-255)</strong><br><a href="../arguments/number.md"><img src="../../../.gitbook/assets/slime_ball.png" alt="" data-size="line"></a> <strong>Зелёный (0-255)</strong><br><a href="../arguments/number.md"><img src="../../../.gitbook/assets/slime_ball.png" alt="" data-size="line"></a> <strong>Синий (0-255)</strong></td></tr><tr><td><img src="../../../.gitbook/assets/white_dye.png" alt="" data-size="line"> <strong>Сбросить цвет значка на локаторе</strong><br><code>player_reset_waypoint_color</code></td><td>Устанавливает игроку цвет значка, отображаемого на локаторе, по умолчанию.<br><br>» Для работы действия, игровое правило "Видимость локатора" должно быть включено.</td><td></td></tr></tbody></table>
{% endtab %}
...
<table data-full-width="true"><thead><tr><th>Опция</th><th>Описание</th><th>Аргументы</th></tr></thead><tbody><tr><td><img src="../../../.gitbook/assets/iron_boots.png" alt="" data-size="line"> <strong>Выгнать игрока</strong><br><code>player_kick</code></td><td>Выгоняет игрока из мира.</td><td></td></tr><tr><td><img src="../../../.gitbook/assets/golden_boots.png" alt="" data-size="line"> <strong>Переместить игрока в другой мир</strong><br><code>player_redirect_world</code></td><td>Перемещает игрока в мир с указанным ID.</td><td><a href="../arguments/text.md"><img src="../../../.gitbook/assets/book.png" alt="" data-size="line"></a> <strong>ID мира</strong></td></tr><tr><td><img src="../../../.gitbook/assets/painting.png" alt="" data-size="line"> <strong>Показать скорборд</strong><br><code>player_show_scoreboard</code></td><td>Отображает определённый скорборд игроку. Для отображения указанный скорборд должен иметь минимум одно значение.</td><td><a href="../arguments/text.md"><img src="../../../.gitbook/assets/book.png" alt="" data-size="line"></a> <strong>ID скорборда</strong></td></tr><tr><td><img src="../../../.gitbook/assets/structure_void.png" alt="" data-size="line"> <strong>Скрыть скорборд</strong><br><code>player_hide_scoreboard</code></td><td>Скрывает текущий скорборд игрока.</td><td></td></tr><tr><td><img src="../../../.gitbook/assets/furnace.png" alt="" data-size="line"> <strong>Получить NBT-теги игрока</strong><br><code>player_get_nbt</code></td><td>Получает NBT-теги игрока по введённому пути и присваивает результат к переменной.</td><td><a href="../arguments/variable/"><img src="../../../.gitbook/assets/magma_cream.png" alt="" data-size="line"></a> <strong>Переменная для присвоения</strong><br><a href="../arguments/text.md"><img src="../../../.gitbook/assets/book.png" alt="" data-size="line"></a> <strong>Путь</strong><br><a href="../arguments/parameter/enum.md"><img src="../../../.gitbook/assets/heart_of_the_sea.png" alt="" data-size="line"></a> <strong>Тип данных</strong> <a data-footnote-ref href="#user-content-fn-63"><strong><code>-></code></strong></a></td></tr><tr><td><img src="../../../.gitbook/assets/saddle.png" alt="" data-size="line"> <strong>Отправить игрока на другой сервер</strong><br><code>player_connect_to_server</code></td><td>Отправляет игрока на сервер с указанным именем (например, "cr-0").<br><br>» По умолчанию, недоступно в мире. Действие используется администрацией для миров-перенаправлений игроков с Creative+ на другие режимы проекта.</td><td><a href="../arguments/text.md"><img src="../../../.gitbook/assets/book.png" alt="" data-size="line"></a> <strong>Имя сервера</strong></td></tr><tr><td><img src="../../../.gitbook/assets/emerald.png" alt="" data-size="line"> <strong>Запросить транзакцию</strong><br><code>send_currency_transaction</code></td><td>Отправляет игроку запрос на совершение транзакции в изумрудах.<br><br>» По умолчанию, недоступно в мире. Доступ предоставляется администрацией по заявкам.</td><td><a href="../arguments/number.md"><img src="../../../.gitbook/assets/slime_ball.png" alt="" data-size="line"></a> <strong>Количество изумрудов</strong><br><a href="../arguments/text.md"><img src="../../../.gitbook/assets/book.png" alt="" data-size="line"></a> <strong>Описание транзакции</strong><br><a href="../arguments/text.md"><img src="../../../.gitbook/assets/book.png" alt="" data-size="line"></a> <strong>Причина запроса транзакции</strong></td></tr><tr><td><img src="../../../.gitbook/assets/diamond.png" alt="" data-size="line"> <strong>Переместить на другой сервер</strong><br><code>player_transfer_to_other_server</code></td><td>Перемещает игрока на указанный сервер.<br><br>» Если оставить аргумент "Порт сервера" пустым, будет применён порт по умолчанию (25565).<br>» По умолчанию, недоступно в мире.</td><td><a href="../arguments/text.md"><img src="../../../.gitbook/assets/book.png" alt="" data-size="line"></a> <strong>Домен/IP-адрес сервера</strong><br><a href="../arguments/number.md"><img src="../../../.gitbook/assets/slime_ball.png" alt="" data-size="line"></a> <strong>Порт сервера</strong></td></tr></tbody></table>
{% endtab %}
{% endtabs %}
...
<table data-search="false"><thead><tr><th>Селектор</th><th>Описание</th></tr></thead><tbody><tr><td><img src="../../../.gitbook/assets/nether_star.gif" alt="" data-size="line"> <strong>Текущая цель</strong></td><td>Игроки, мобы и существа выбранные с помощью <a href="select.md"><img src="../../../.gitbook/assets/purpur_block.png" alt="" data-size="line"> <strong>Выбрать цель</strong></a>.</td></tr><tr><td><img src="../../../.gitbook/assets/potato.png" alt="" data-size="line"> <strong>Игрок по умолчанию</strong></td><td>Игрок, который спровоцировал данное событие.</td></tr><tr><td><img src="../../../.gitbook/assets/iron_sword.png" alt="" data-size="line"> <strong>Убийца</strong></td><td>Игрок, который убил жертву в данном событии.</td></tr><tr><td><img src="../../../.gitbook/assets/stone_sword.png" alt="" data-size="line"> <strong>Атакующий</strong></td><td>Игрок, который атаковал жертву в данном событии.</td></tr><tr><td><img src="../../../.gitbook/assets/bow.png" alt="" data-size="line"> <strong>Стрелок</strong></td><td>Игрок, который выстрелил в данном событии.</td></tr><tr><td><img src="../../../.gitbook/assets/skeleton_skull.png" alt="" data-size="line"> <strong>Жертва</strong></td><td>Игрок, который получил урон или убит в данном событии.</td></tr><tr><td><img src="../../../.gitbook/assets/ender_eye.png" alt="" data-size="line"> <strong>Случайный игрок</strong></td><td>Случайный игрок в мире.</td></tr><tr><td><img src="../../../.gitbook/assets/beacon.png" alt="" data-size="line"> <strong>Все игроки</strong></td><td>Все игроки в мире.</td></tr></tbody></table>
...
[^3]: **Тип руки** `equipment`:

    * <img src="../../../.gitbook/assets/iron_sword.png" alt="" data-size="line"> **Основная рука** `main_hand`
    * <img src="../../../.gitbook/assets/shield.png" alt="" data-size="line"> **Второстепенная рука** `off_hand`
...
[^12]: **Тип обновления** `setting_mode`:
...
[^16]: **Тип функционала** `menu_type`:

    * <img src="../../../.gitbook/assets/crafting_table.png" alt="" data-size="line"> **Верстак**\
      `crafting`
    * <img src="../../../.gitbook/assets/anvil.png" alt="" data-size="line"> **Наковальня**\
      `anvil`
    * <img src="../../../.gitbook/assets/smithing_table.png" alt="" data-size="line"> **Кузнечный стол**\
      `smithing`
    * <img src="../../../.gitbook/assets/cartography_table.png" alt="" data-size="line"> **Стол картографа**\
      `cartography_table`
    * <img src="../../../.gitbook/assets/loom.png" alt="" data-size="line"> **Ткацкий станок**\
      `loom`
    * <img src="../../../.gitbook/assets/grindstone.png" alt="" data-size="line"> **Точило**\
      `grindstone`
    * <img src="../../../.gitbook/assets/stonecutter.gif" alt="" data-size="line"> **Камнерез**\
...
[^21]: **Перезаписывать существующие эффекты** `overwrite`:
...
[^22]: **Показывать иконку эффекта** `show_icon`:
...
[^23]: **Показывать частицы** `particle_mode`:
...
[^24]: **Блокировка состояния (время не будет изменяться)** `ticking_locked`:
...
[^26]: **Тип атрибута** `attribute_type`:
...
[^32]: **Выпадение предметов** `death_drops`:
...
[^34]: **Режим столкновения** `collidable`:
...
[^37]: **Мгновенное возрождение** `instant_respawn`:
...
[^38]: **Оставить текущий поворот** `keep_rotation`:
...
[^39]: **Сохранение инерции** `keep_velocity`:
...
[^40]: **Спешиться после телепортации** `dismount`:
...
[^41]: **Учитывать текущую инерцию** `increment`:
...
[^44]: **Полёт на элитрах** `is_gliding`:
...
[^47]: **Сторона таблички** `side`:
    ...
    * <img src="../../../.gitbook/assets/dark_oak_sign.png" alt="" data-size="line"> **Задняя**\
      `back`
    * <img src="../../../.gitbook/assets/cherry_sign.png" alt="" data-size="line"> **Любая**\
      `all`

[^48]: **Направление удара** `direction`:
...
[^53]: **Тип отображения частиц** `unit_of_measurement`:
...
[^56]: **Видимость для игрока** `visible_to_self`:
...
[^57]: **Тип сервера скинов** `server_type`:
...
[^62]: **Установить визуальный огонь** `visual_fire`:
