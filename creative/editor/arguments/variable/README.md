...
| Тип                                                      | Описание                                                                                                                                                                                                               | Лимит    |
| -------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| <p><strong>Игровая</strong><br><code>game</code></p>     | Действует во всём коде, очищается после перезагрузки мира                                                                                                                                                              | 250 тыс. |
| <p><strong>Сохранённая</strong><br><code>save</code></p> | Работает так же, как игровая, но не очищается.                                                                                                                                                                         | 800 тыс. |
| <p><strong>Локальная</strong><br><code>local</code></p>  | Действует в пределах одной ветви кода, она очищается после выполнения этой ветви. Ветвью считается какая-либо строка кода, а также вызывающиеся из неё процессы, у которых выбран режим переменных "общие", и функции. | 25 тыс.  |
| <p><strong>Строчная</strong><br><code>line</code></p>    | Действует в пределах одной строки кода. При передаче аргументов в функцию, в строке будет автоматически создана данная переменная сразу с нужным значением.                                                            | 25 тыс.  |
