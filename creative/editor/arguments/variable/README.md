...
<table><thead><tr><th>Тип</th><th width="375">Описание</th><th>Лимит</th></tr></thead><tbody><tr><td><strong>Игровая</strong><br><code>game</code></td><td>Действует во всём коде, очищается после перезагрузки мира</td><td>250 тыс.</td></tr><tr><td><strong>Сохранённая</strong><br><code>save</code></td><td>Работает так же, как игровая, но не очищается.</td><td>800 тыс.</td></tr><tr><td><strong>Локальная</strong><br><code>local</code></td><td>Действует в пределах одной ветви кода, она очищается после выполнения этой ветви. Ветвью считается какая-либо строка кода, а также вызывающиеся из неё процессы, у которых выбран режим переменных "общие", и функции.</td><td>25 тыс.</td></tr><tr><td><strong>Строчная</strong><br><code>line</code></td><td>Действует в пределах одной строки кода. При передаче аргументов в функцию, в строке будет автоматически создана данная переменная сразу с нужным значением.</td><td>25 тыс.</td></tr></tbody></table>
