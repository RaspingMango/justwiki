---
description: >-
  Значение, используемое для хранения множества значений в формате словаря
  (ключ=значение).
---

# Словарь

<figure><img src="../../../../.gitbook/assets/chest_minecart.png" alt="" width="150"><figcaption></figcaption></figure>
