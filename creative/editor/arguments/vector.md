...
Вы можете «нормализовать» вектор, установив его длину равной `1`, с помощью команды [`/vector`](#user-content-fn-1)[^1] `normalize`.\
Также можно умножить длину вектора с помощью команды [`/vector`](#user-content-fn-1)[^1] `multiply <число>`.

* Нажатие <kbd>ПКМ</kbd> выводит свойства вектора в чат;
* Нажатие <kbd>ЛКМ</kbd> покажет направление вектора в виде частиц;
