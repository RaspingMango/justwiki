...
| <p><img src="../../../.gitbook/assets/code_potion_heal.png" alt="" data-size="line"> <strong>Насыщение</strong><br><code>saturation</code></p>                             | Мгновенно восполняет `1 × уровень` единиц сытости и `2 × уровень` единиц насыщения.                                 |
