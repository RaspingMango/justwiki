...
Вы также можете привязать значение маркера к переменной. Для этого возьмите переменную в инвентаре и, наведя курсор с переменной на маркер, нажмите <kbd>ПКМ</kbd>/<kbd>ЛКМ</kbd>.
